...
//!	Generated Date	: Sat, 11, Sep 2021  
	File Path	: DefaultComponent\DefaultConfig\RainAmountSensor.cpp
*********************************************************************/
...
void OMAnimatedRainAmountSensor::rootState_serializeStates(AOMSState* aomsState) const {
    ...
    switch (myReal->rootState_subState) {
        case RainAmountSensor::OczekiwanieSensor:
        {
...
void OMAnimatedRainAmountSensor::OczekiwanieSensor_serializeStates(AOMSState* aomsState) const {
