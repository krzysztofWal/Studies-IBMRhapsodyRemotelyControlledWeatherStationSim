...
//!	Generated Date	: Mon, 13, Sep 2021  
	File Path	: MainComponent\MainConfiguration\WindDirectionSensor.h
*********************************************************************/
...
#ifdef _OMINSTRUMENT
    friend class OMAnimatedWindDirectionSensor;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    WindDirectionSensor(IOxfActive* theActiveContext = 0);
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedWindDirectionSensor : public OMAnimatedSensor {
    DECLARE_REACTIVE_META(WindDirectionSensor, OMAnimatedWindDirectionSensor)
