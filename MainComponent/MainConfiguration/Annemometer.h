...
//!	Generated Date	: Mon, 13, Sep 2021  
	File Path	: MainComponent\MainConfiguration\Annemometer.h
*********************************************************************/

#ifndef Annemometer_H
#define Annemometer_H
...
//## class Annemometer
class Annemometer : public Sensor {
    ////    Friends    ////
    
public :

#ifdef _OMINSTRUMENT
    friend class OMAnimatedAnnemometer;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    Annemometer(IOxfActive* theActiveContext = 0);
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedAnnemometer : public OMAnimatedSensor {
    DECLARE_REACTIVE_META(Annemometer, OMAnimatedAnnemometer)
