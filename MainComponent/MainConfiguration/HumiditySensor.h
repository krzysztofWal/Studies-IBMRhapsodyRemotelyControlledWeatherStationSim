...
//!	Generated Date	: Mon, 13, Sep 2021  
	File Path	: MainComponent\MainConfiguration\HumiditySensor.h
*********************************************************************/
...
public :
    ...
    //## auto_generated
    HumiditySensor(IOxfActive* theActiveContext = 0);
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedHumiditySensor : public OMAnimatedSensor {
    DECLARE_REACTIVE_META(HumiditySensor, OMAnimatedHumiditySensor)
