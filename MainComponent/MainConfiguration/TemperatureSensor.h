...
//!	Generated Date	: Mon, 13, Sep 2021  
	File Path	: MainComponent\MainConfiguration\TemperatureSensor.h
*********************************************************************/
...
public :
    ...
    //## auto_generated
    TemperatureSensor(IOxfActive* theActiveContext = 0);
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedTemperatureSensor : public OMAnimatedSensor {
