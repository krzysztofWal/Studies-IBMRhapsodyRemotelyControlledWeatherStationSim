...
//!	Generated Date	: Mon, 13, Sep 2021  
	File Path	: MainComponent\MainConfiguration\PressureSensor.h
*********************************************************************/
...
#ifdef _OMINSTRUMENT
    friend class OMAnimatedPressureSensor;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    PressureSensor(IOxfActive* theActiveContext = 0);
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedPressureSensor : public OMAnimatedSensor {
    DECLARE_REACTIVE_META(PressureSensor, OMAnimatedPressureSensor)
